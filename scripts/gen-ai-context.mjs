...
const components = [
  ...
  { name: 'chat (AI)', classes: ['chat', 'message', 'message-out (user)', 'message-body', 'message-bubble', 'message-meta', 'typing'], example: '<div class="chat"><div class="message"><span class="avatar avatar-sm avatar-accent">AI</span><div class="message-body"><div class="message-bubble">Hi</div></div></div></div>' },
