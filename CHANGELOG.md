...
### New gates (all in CI)
- `check:text-contrast` renders every coloured-text class on the page surface and on glass in all 7 themes and skins. Verified to fail on 1.7.7 (124 failures).
